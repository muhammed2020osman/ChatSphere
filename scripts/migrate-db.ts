...
const initialData = {
  disciplines: `
    INSERT IGNORE INTO disciplines (id, name, description, code, color, created_at) VALUES
  ...
  floors: `
    INSERT IGNORE INTO floors (id, name, level, description, project_id, sort_order, created_at) VALUES
